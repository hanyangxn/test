...
public class Main {
    static String pubkey = "297gBsEa7wY8hr313QIr8CYMIodWw1o500429083985e0702ce";
    static String secret = "GZn1mzCBWjCGGrbzmHel";
    ...
    public static void main(String[] args) {
        ...
        String s = DigestUtils.sha1Hex(nonce + timeStamp + secret);
