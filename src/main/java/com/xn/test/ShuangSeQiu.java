...
public class ShuangSeQiu {
    ...
    public static void main(String[] args) {
        for (int i = 0; i <5 ; i++) {
            //11月29日开奖结果对应序号：
//            System.out.println(getBallIndex(3,16,18,31,32,33,12));//12964124
//            System.out.println(getBall(12964124));//[6, 20, 28, 29, 30, 31, 12]
//            //12月1日开奖结果对应序号：
//            System.out.println(getBallIndex(1,3,6,10,11,29,16));//7353378
//            System.out.println(getBall(7353378));//[3, 8, 19, 25, 27, 28, 2]
//            //12月3日开奖结果对应序号：
//            System.out.println(getBallIndex(10,12,15,25,26,27,14));//17009451
